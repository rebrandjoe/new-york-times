...
export const metadata: Metadata = {
  title: "Fact-Checking",
  description:
    "How JOSEPH MMWA verifies health and medical claims before publication — sourcing, scientific context and standards of evidence.",
  alternates: { canonical: "/fact-checking" },
  openGraph: {
    title: "Fact-Checking — Joseph Mmwa",
    description:
      "How JOSEPH MMWA verifies health and medical claims before publication — sourcing, scientific context and standards of evidence.",
    url: "/fact-checking",
  },
...
export default function FactCheckingPage() {
  return (
    <PolicyPage eyebrow="Fact-Checking" title="Fact-Checking" intro="Before we ask the reader to believe it">
      ...
      <PolicySection heading="Our editorial sequence">
        ...
        <PolicyParagraph>
          For research stories, this may mean reviewing the study itself rather than relying solely on
          a press release or social-media description.
        </PolicyParagraph>
        <PolicyParagraph>
      ...
      <PolicySection heading="Research is read in context">
        <PolicyParagraph>
          We pay attention to distinctions that can materially change the meaning of medical evidence.
          For example:
        </PolicyParagraph>
        <PolicyList
          items={[
      ...
      <PolicySection heading="Sources and expertise">
      ...
      <PolicySection heading="Viral claims">
      ...
      <PolicySection heading="AI-generated information">
        <PolicyParagraph>
      ...
      <PolicySection heading="Attribution">
        <PolicyParagraph>
      ...
      <PolicySection heading="After publication">
        <PolicyParagraph>Verification does not necessarily end when an article goes live.</PolicyParagraph>
        <PolicyParagraph>
          If new evidence emerges or a reader identifies a credible factual concern, we review the
          relevant material.
        </PolicyParagraph>
        <PolicyParagraph>If a material error is confirmed, our Corrections Policy applies.</PolicyParagraph>
      </PolicySection>
      ...
      <PolicySection heading="Our standard">
        ...
        <PolicyParagraph>That distinction matters.</PolicyParagraph>
      </PolicySection>
    </PolicyPage>
  );
}
